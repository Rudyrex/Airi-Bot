...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Airi-Bot', 'Safari', '2.0.0'] : methodCodeQR ? ['Airi-Bot', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '110.0.5585.95'],
auth: {
creds: state.creds,
...
do {
phoneNumber = await question(chalk.bgBlack(chalk.bold.yellowBright('Por favor, escribe tu número de WhatsApp.\nEjemplo: 51955918117\n')))
